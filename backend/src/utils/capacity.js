...
// the storage's available space. Only capacity violations throw (with
// err.status = 400); if Proxmox can't be queried the check is skipped rather
// than blocking provisioning on a monitoring hiccup — the clone/create call
